...
function WhatsAppIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-10 h-10" fill="#25D366" aria-hidden="true">
...
function ContactCard({ icon, label, value, subLabel, href, external }: ContactCardProps) {
  ...
  return (
    <motion.a
      ...
      whileHover={
        prefersReduced
          ? undefined
          : { scale: 1.02, boxShadow: '0 0 32px rgba(255, 46, 46, 0.2)' }
      }
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        {subLabel && (
          <span className="font-mono text-[10px] tracking-[0.15em] uppercase text-netrix-gray-dark mt-0.5">
            {subLabel}
          </span>
        )}
      </div>
